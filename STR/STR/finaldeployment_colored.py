...
# Load the models
model_clay = pickle.load(open('D:\Courses\Prgoramming\Gradutaion Project\FlexStart\STR\soil_claymodel_lr.pkl', 'rb'))
model_sand = pickle.load(open('D:\Courses\Prgoramming\Gradutaion Project\FlexStart\STR\soil_sandmodel_lr.pkl', 'rb'))
model_silt = pickle.load(open('D:\Courses\Prgoramming\Gradutaion Project\FlexStart\STR\soil_siltmodel_lr.pkl', 'rb'))
